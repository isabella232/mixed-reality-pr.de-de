...
* **Unterstützt eine große Bandbreite an Plattformen**, darunter
  * OpenXR (Unity 2020.2 oder höher)
  ...
  * Windows Mixed Reality
    ...
    * Microsoft HoloLens 2
    * Windows Mixed Reality-Headsets
  * Oculus (Unity 2019.3 oder höher)
    * Oculus Quest
  * OpenVR
    * Windows Mixed Reality-Headsets
    * HTC Vive
...
Wenn Sie mit der MRTK- oder Mixed Reality-Entwicklung in Unity noch nicht vertraut sind, empfehlen wir Ihnen, die notwendigen Tools zu installieren und dann die HoloLens 2-Tutorialreihe zu absolvieren.
...
:::row:::
    :::column:::
       [![Handphysikdienst](features/images/hand-physics/MRTK_UX_HandPhysics_Main.jpg)](features/experimental/hand-physics-service.md) **[Handphysikdienst [Experimentell]](features/experimental/hand-physics-service.md)**<br>
...
Erkunden Sie die verschiedenen Arten von Interaktionen und Benutzeroberflächen-Steuerelementen des MRTK in [dieser Beispielszene](features/example-scenes/hand-interaction-examples.md).
...
Weitere Sitzungsvideos finden Sie unter [Mixed Reality Dev Days](https://docs.microsoft.com/windows/mixed-reality/mr-dev-days-sessions).
