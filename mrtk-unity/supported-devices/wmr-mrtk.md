...
---
# <a name="building-and-deploying-mrtk-uwp"></a>Erstellen und Bereitstellen von MRTK (UWP)
...
## <a name="building-and-deploying-mrtk-standalone"></a>Erstellen und Bereitstellen von MRTK (eigenständig)
