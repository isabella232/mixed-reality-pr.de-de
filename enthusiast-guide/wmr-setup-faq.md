...
Hier sind einige Informationen, die Ihnen helfen, Probleme zu beheben, die beim Einrichten des Windows Mixed Reality-immersiven Headsets auftreten können.
...
3. Wechseln Sie zu **Einstellungen > aktualisieren Sie & Sicherheits > Windows Update** , und vergewissern Sie sich, dass Windows Update aktiviert ist. Anschließend können Sie alle Updates herunterladen und installieren, die auf die Installation warten.
4. Stellen Sie erneut eine Verbindung mit dem Computer her, und wiederholen Sie dann das Setup.

Wenn die oben genannten Schritte nicht funktionieren, deinstallieren Sie Windows Mixed Reality, und installieren Sie es anschließend neu. Wechseln Sie zu **Einstellungen > gemischte Realität > deinstallieren** , und wählen Sie **deinstallieren** aus. Starten Sie den Computer neu. Wenn Sie den Setup Vorgang erneut starten möchten, können Sie Ihr Headset einfach an Ihren PC anschließen.
...
* Informieren Sie sich bei Ihrem Grafikkartenhersteller über die neuesten Treiber Updates. Für Windows Mixed Reality ist ein Grafikkartentreiber erforderlich, der mindestens WDDM 2,2 unterstützt.
...
* Wenn Sie einen Bluetooth-Controller verwenden, wechseln Sie zu **Einstellungen > Geräte > Bluetooth & andere Geräte** auf Ihrem PC, und stellen Sie sicher, dass Sie gekoppelt sind. (Sie sollten auf der Seite angezeigt werden.)

[Weitere Informationen zu Xbox-Controllern](https://support.xbox.com/xbox-on-windows/accessories/connect-xbox-one-controller-to-pc)
...
* Schalten Sie die Controller ein-und ausschalten, während Sie diese vor Ihnen halten. Drücken Sie die Windows-Taste 4 Sekunden, um einen Controller zu deaktivieren, und halten Sie ihn dann erneut für 2 Sekunden gedrückt, um ihn zu aktivieren.
* Wechseln Sie zu **Einstellungen > Geräte > Bluetooth & andere Geräte** auf Ihrem PC, und stellen Sie sicher, dass Sie gekoppelt sind. (diese werden auf der Seite aufgeführt.)

[Weitere Informationen zu Bewegungs Controllern](controllers-in-wmr.md)
...
## <a name="when-i-plug-in-my-headset-nothing-happensmixed-reality-portal-doesnt-open"></a>Wenn ich mein Headset Anfüge, passiert nichts, – das gemischte Reality-Portal wird nicht geöffnet.

Mixed Reality Portal, die APP, die Sie durch das Windows Mixed Reality-Setup führt, ist so konzipiert, dass Sie automatisch geöffnet wird, wenn Sie ein kompatibles Headset einbinden. Wenn dies nicht der Fall ist, navigieren Sie zu **Start** , und geben Sie im **Suchfeld** das **gemischte Reality-Portal** ein, um die APP dort zu öffnen. Wenn Sie das Mixed Reality-Portal nicht finden, bedeutet dies möglicherweise, dass Sie ein [Update auf die neueste Version von Windows durch](https://support.microsoft.com/help/12373) führen müssen oder dass Ihr Headset nicht ordnungsgemäß mit dem PC verbunden ist.

## <a name="my-head-mount-display-doesnt-work-after-i-shut-down-and-do-a-fast-startup"></a>Meine Head-Einstellungsanzeige funktioniert nach dem Herunterfahren und Durchführen eines schnellen Starts nicht mehr

Testen Sie Folgendes:

* Entfernen Sie das Anzeige Kabel und das USB-Kabel von der Head-EinstellungenAnzeige, und binden Sie Sie dann wieder ein.
...
> [!NOTE]
> Neuere Headsets werden direkt über einen integrierten Bluetooth-Chip mit den Controllern gekoppelt, und dieses Problem sollte nicht auftreten.
