...
1. **Mixed Reality-Portal**, das die Haupt Darstellung von Windows Mixed Reality bietet
    * In Windows 10, Version 1709 und 1803, ist das Mixed Reality-Portal eine wichtige Komponente des Windows 10-Betriebssystems und wird über Windows Update aktualisiert.
...
Außerdem erfordert die Verwendung von Windows Mixed Reality in steamvr die folgende Software:
...
* Ändert das Verhalten der Einstellung "90 Hz-Aktualisierungsrate" in Windows Mixed Reality so, dass in bestimmten Fällen nicht mehr automatisch zu 60 Hz gewechselt wird, wenn 90Hz nicht erreicht werden kann. 
