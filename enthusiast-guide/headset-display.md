...
Diese Informationen werden auch in einem [Flussdiagramm zur Problem](headset-display-chart.md)Behandlung angezeigt.
...
## <a name="my-pc-or-headset-displays-flicker-flash-or-remain-black-when-using-a-surface-pc"></a>Der PC oder das Headset zeigt Flimmern, Flash an oder bleibt schwarz, wenn ein Surface-PC verwendet wird.
...
## <a name="the-view-in-the-headset-is-jittering-and-stuttering-a-lot"></a>Die Ansicht im Headset ist Jittering und wird sehr viel zu einer Menge.
