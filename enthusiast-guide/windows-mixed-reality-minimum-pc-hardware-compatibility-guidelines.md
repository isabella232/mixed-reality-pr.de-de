...
Windows 10 ermöglicht Windows Mixed Reality und Windows Mixed Reality Ultra. Welche Version Sie erleben, hängt von Ihrer PC-Hardware ab.
...
>[!NOTE]
>Die Richtlinien für Entwicklungs-PCs sind höher als bei PCs, auf denen gemischte Reality-apps ausgeführt werden. Wenn Sie ein Mixed Reality-Entwickler sind, finden Sie weitere Informationen unter [Empfohlene Entwicklungs-PC-Spezifikationen](https://developer.microsoft.com/en-us/windows/mixed-reality/install_the_tools#immersive_headset_development)


## <a name="mixed-reality-portal-app"></a>Mixed Reality Portal-App

Das Mixed Reality-Portal ist die beste Möglichkeit, um sicherzustellen, dass Ihr PC für die Durchführung von Windows Mixed Reality bereit ist. 
...
<td> <img alt="Error" width="30" height="30" src="images/glyph-error.png" /></td><td style="vertical-align: middle">Der PC erfüllt die Anforderungen für das angegebene Element nicht.</td>
 ...
 [Hilfe zu den Ergebnissen des Mixed Reality-Portals](https://support.microsoft.com/en-us/help/4045777/windows-10-get-help-with-pc-compatibility-in-windows-mixed-reality)
...
<li> NVIDIA GeForce GTX 1080, AMD Radeon RX 5700, gleichwertig oder besser </li> 
<li> Arbeitsspeicher: 8 GB RAM oder mehr </li> 
<li> 1X-Anzeige Port 1,3 </li> 
<li> 1X USB 3,0 Type-C mit Stromversorgung (oder eingebundenen Strom Adapter)</li>
...
<tr>
    ...
    <td style="vertical-align: middle; text-align: center;">Intel Core i5 4590 (4. Generation), Quad-Core (oder besser) <br>AMD ryzen 5 1400 3.4 GHz (Desktop), Quad-Core (oder besser)</td>
    <td style="vertical-align: middle; text-align: center;">Intel Core i5 7200U (7. Generation Mobile), Dual-Core mit aktivierter Intel Hyper-Threading Technology (oder höher) <br>AMD ryzen 5 1400 3.4 GHz (Desktop), Quad-Core (oder besser)</td>
</tr><tr>
    <td style="vertical-align: middle">RAM</td>
    <td style="vertical-align: middle; text-align: center;">8 GB DDR3 (oder besser)</td>
    <td style="vertical-align: middle; text-align: center;">2-GB-DDR3-Dual-Channel (oder besser)</td>
</tr><tr>
    <td style="vertical-align: middle">Freier Speicherplatz</td>
    <td colspan="3" style="vertical-align: middle; text-align: center;">Mindestens 10 GB</td>
    <td colspan="3" style="vertical-align: middle; text-align: center;">Mindestens 10 GB</td>
</tr><tr>
    ...
    <td style="vertical-align: middle; text-align: middle;">
            ...
            <b>Hinweis:</b> GPU muss in einem PCIe 3,0 X4 +-linkslot gehostet werden. </td>
    <td style="vertical-align: middle; text-align: middle;">
            <li>Integrierte Intel HD-Grafiken 620 (oder höher) DX12-fähiger integrierter GPU <a href="https://en.wikipedia.org/wiki/List_of_Intel_graphics_processing_units">(überprüfen Sie, ob das Modell höher ist)</a></li>
        <li>NVIDIA MX150 (oder größer) diskrete GPU</li>
        <li>NVIDIA GeForce GTX 1050 diskrete GPU</li>
        <li>NVIDIA 965m diskrete GPU</li>
        <li>AMD Radeon RX 460/560</li>
        </ul>
        <b>Hinweis:</b> Ältere Intel-GPUs wie HD-Grafiken 4xx, 5xx, 2xxx, 3xxx, 4xxx, 5xxx und 6xxx werden nicht unterstützt.
    </td>
</tr><tr>
    <td style="vertical-align: middle">Grafiktreiber</td>
    <td colspan="3" td style="vertical-align: middle; text-align: center;">Windows-Anzeigetreiber Modell (WDDM) 2,2</td>
</tr><tr>
    <td style="vertical-align: middle"><a href="Recommended-adapters-for-Windows-Mixed-Reality-Capable-PCs.md">Grafik Anzeige Port</a></td>
    <td style="vertical-align: middle; text-align: center;">HDMI 2,0 oder Display Port 1,2</td>
    <td style="vertical-align: middle; text-align: center;">HDMI 1,4 oder Display Port 1,2</td>
</tr><tr>
    <td style="vertical-align: middle">Anzeige</td>
    <td colspan="3" style="vertical-align: middle; text-align: center;">Verbundene externe oder integrierte VGA (800x600) Anzeige (oder besser)</td>
</tr><tr>
    ...
    <td colspan="2" style="vertical-align: middle; text-align: center;">USB 3,0 Typ-A </td>
</tr><tr>
    <td style="vertical-align: middle">Bluetooth-Konnektivität (für <a href="controllers-in-wmr.md">Bewegungs Controller</a>)</td>
...
>[!NOTE]
>Diskrete und integrierte Grafikhardware, die nicht den bestätigten Mindestanforderungen entspricht, wurde nicht getestet, bestätigt oder für Windows Mixed Reality optimiert und funktioniert möglicherweise nicht ordnungsgemäß oder gar nicht.
...
Weitere Informationen zur Oberflächen Kompatibilität mit Windows Mixed Reality finden Sie in der folgenden Tabelle:

<table>
    <tr>
        <th> Surface-Gerät </th><th> Unterstützung für Windows Mixed Reality-Funktionen? </th><th> Empfohlene Konfiguration </th><th> Notizen</th>
    </tr>
    <tr>
        <td style="vertical-align: middle"> Surface pro (Original)/Surface pro 2 </td><td style="vertical-align: middle"> Keine </td><td> </td><td></td>
    </tr>
    <tr>
        <td style="vertical-align: middle"> Surface Pro 3 </td><td style="vertical-align: middle"> Keine </td><td> </td><td></td>
    </tr>
(bei installiertem Windows 10 pro) <tr>
        <td style="vertical-align: middle"> Surface Pro 4 </td><td style="vertical-align: middle"> Keine </td><td> </td><td></td>
    </tr>
    <tr>
        <td style="vertical-align: middle"> Surface 3 </td><td style="vertical-align: middle"> Keine </td><td> </td><td></td>
    </tr>
    <tr>
        <td style="vertical-align: middle"> Surface Book </td><td style="vertical-align: middle"> Keine </td><td> </td><td></td>
    </tr>
    <tr>
        <td style="vertical-align: middle"> Surface Book mit Leistungsbasis </td><td style="vertical-align: middle"> Keine </td><td> </td><td></td>
    </tr>
    <tr>
        <td style="vertical-align: middle"> Surface Go </td><td style="vertical-align: middle"> Keine </td><td> </td><td></td>
    </tr>
<tr>
