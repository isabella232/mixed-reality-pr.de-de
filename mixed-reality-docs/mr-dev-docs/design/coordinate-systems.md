...
| Erfahrungs Skala | Requirements (Anforderungen) | Beispiel Darstellung | 
|----------|----------|----------|
...
In [gemischter Realität](../discover/mixed-reality.md)werden Ihre apps sowohl für virtuelle als auch für physische Koordinatensysteme in den Grund. Windows Ruft ein Koordinatensystem auf, das in der physischen Welt ein **räumliches Koordinatensystem** hat.
