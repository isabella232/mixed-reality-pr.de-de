...
- [Pixel](https://devblogs.microsoft.com/pix/)
- [GPU-poprofilierung in Unreal](https://docs.unrealengine.com/en-US/TestingAndOptimization/PerformanceAndProfiling/GPU/index.html)
