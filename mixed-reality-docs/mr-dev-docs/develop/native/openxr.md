...
Die openxr-Laufzeit von Windows Mixed Reality unterstützt eine Reihe von `MSFT` -und- `EXT` Erweiterungen, die den vollständigen Satz von hololens 2-Funktionen zu openxr-Anwendungen bringt:
...
Unreal Engine 4,23 war außerdem die erste Haupt-Engine-Version für die Bereitstellung von Vorschau Unterstützung für openxr 1,0!  In der **Unreal Engine 4,26** ist die Unterstützung für hololens 2, Windows Mixed Reality und andere Desktop-VR-Headsets nun über die integrierte openxr-Unterstützung von Unreal Engine verfügbar.  Unreal Engine 4,26 unterstützt auch das [openxr-Erweiterungs-Plug-](https://github.com/microsoft/Microsoft-OpenXR-Unreal)in von Microsoft, das die Unterstützung von Hand Interaktion und HP-Reverb-Controller unterstützt, das [vollständige Feature von hololens 2 und Windows Mixed Reality-Headsets](#roadmap)beleuchtet.  Unreal Engine 4,26 ist heute am [Epic Games Launcher](https://www.unrealengine.com/download/creators)verfügbar, wobei MRTK-Unreal Support später im April verfügbar ist.
