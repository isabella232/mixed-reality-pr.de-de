...
2.  Im Feld " **Unity-Paket importieren** ", das angezeigt wird, können Sie unter * *_Plugin_ \> * Storage * * * die Option Alles auswählen.  Deaktivieren Sie alles andere, da es für diesen Kurs nicht benötigt wird.
