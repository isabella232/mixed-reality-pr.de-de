...
Diese Anwendung verwendet die *Microsoft. projectoxford. Face* -Bibliotheken, die es Ihnen ermöglichen, den Gesichtserkennungs-API vollständig zu nutzen. Diese Bibliothek steht als nuget-Paket kostenlos zur Verfügung. Weitere Informationen zu diesem und ähnlichen APIs [finden Sie im Artikel zur API-Referenz](/azure/cognitive-services/face/apireference).
